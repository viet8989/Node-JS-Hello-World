...
const outputFile = path.join(__dirname, 'tanphat_tables.sql');
...
const dumpCommand = `${pgDumpPath} -U ${dbConfig.user} -h ${dbConfig.host} -d ${dbConfig.database} --schema-only -F p -f ${outputFile}`;
